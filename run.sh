...
if [ ${CREATE_CUSTOM} -eq 1 ]; then
	...
	do
		[[ ! -L ${CUSTOM_FOLDER}/terraform/${FOLDER}.tf -a -f ../../${FOLDER}/terraform/${FOLDER}.tf ]] && ln -s ../../${FOLDER}/terraform/${FOLDER}.tf ${CUSTOM_FOLDER}/terraform/${FOLDER}.tf
		[[ ! -L ${CUSTOM_FOLDER}/terraform/${FOLDER}.tf.disabled -a -f ../../${FOLDER}/terraform/${FOLDER}.tf.disabled ]] && ln -s ../../${FOLDER}/terraform/${FOLDER}.tf.disabled ${CUSTOM_FOLDER}/terraform/${FOLDER}.tf.disabled
	done
